...
public class Aims {
	...
	public static void main(String[] args) throws PlayerException, LimitedExceededException {
    ...
    private static void CartMenuChoice(int cartChoice, Cart cart) throws PlayerException {
